...
from simsiam.operations import Genotype, OPERATIONS
def parse_genotype(alphas_encoder, alphas_predictor, path = None, parse_method='sparse', model_name=''):
  primitives = list(OPERATIONS.keys())
  genes_encoder = parse(alphas_encoder, primitives, parse_method)
  genes_predictor = parse(alphas_predictor, primitives, parse_method)
  genotype = Genotype(encoder=genes_encoder, predictor=genes_predictor)
